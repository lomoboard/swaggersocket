...
func NewSwaggerPetstoreAPI(spec *loads.Document) *SwaggerPetstoreAPI {
	return &SwaggerPetstoreAPI{
		...
		GetPetsHandler: GetPetsHandlerFunc(func(params GetPetsParams) middleware.Responder {
...
type SwaggerPetstoreAPI struct {
	...
	// GetPetsHandler sets the operation handler for the get pets operation
...
func (o *SwaggerPetstoreAPI) Validate() error {
	...
	if o.GetPetsHandler == nil {
		unregistered = append(unregistered, "GetPetsHandler")
	}
...
func (o *SwaggerPetstoreAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/pets"] = NewGetPets(o.context, o.GetPetsHandler)
}
